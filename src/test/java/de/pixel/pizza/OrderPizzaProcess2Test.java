...
public class OrderPizzaProcess2Test {

    private static final Logger LOGGER = LoggerFactory.getLogger(OrderPizzaProcess2Test.class);
    ...
    public void complete_pizza_order() throws Exception {
        // given
        String processDefinitionKey = "OrderPizzaProcess2";
